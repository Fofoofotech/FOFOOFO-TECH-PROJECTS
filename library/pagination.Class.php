...
class OS_Paginations{
	...
	function renderFullNav() {
        ...
        function limitList($limit,$formname){
            ...
            echo '<select name="limit" onchange="document.getElementById(\'viewpage\').value=\'pageview\';document.getElementById(\'view\').value=\'viewlist\';document.getElementById(\'view\').value=\'viewdetails\';document.'.$formname.'.submit()" class="shortes">
