                ...
                <div class="col-md-5">
                    <div class="widget-indicators">
                        <div class="indicator-item">
                            ...
                            <div class="indicator-item-value"><span class="indicator-value-counter" data-toggle="counter" data-end="36">0</span>
                        ...
                        <div class="indicator-item">
                            ...
                            <div class="indicator-item-value"><span class="indicator-value-counter" data-toggle="counter" data-end="157">0</span>
                        ...
                        <div class="indicator-item">
                            ...
                            <div class="indicator-item-value"><span class="indicator-value-counter" data-toggle="counter" data-decimals="1" data-end="17.9">0</span>
                        ...
                        <div class="indicator-item">
                            ...
                            <div class="indicator-item-value"><span class="indicator-value-counter" data-toggle="counter" data-decimals="2" data-end="78,450" data-prefix="$">0</span>
                ...
                <div class="col-lg-4">
                    <div class="widget widget-fullwidth week-chart">
                        ...
                        <div class="row widget-info">
                            <div class="col-6 counter-block"><span class="counter" data-toggle="counter" data-end="735"></span><span class="title">New Users</span></div>
                            <div class="col-6 counter-block"><span class="counter" data-toggle="counter" data-end="73" data-suffix="%">0</span><span class="title">More Visits</span></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="user-stats">
                        ...
                        <div class="user-stats-indicators">
                            <div class="user-stats-indicator"><span class="user-stats-indicator-title">Premium Purchases</span><span class="user-stats-indicator-counter" data-toggle="counter" data-end="173">0</span></div>
                            <div class="user-stats-indicator"><span class="user-stats-indicator-title">Standard Plans	</span><span class="user-stats-indicator-counter" data-toggle="counter" data-end="367">0</span></div>
                            <div class="user-stats-indicator"><span class="user-stats-indicator-title">Services</span><span class="user-stats-indicator-counter" data-toggle="counter" data-end="724">0</span></div>
                            <div class="user-stats-indicator"><span class="user-stats-indicator-title">Total Sales</span><span class="user-stats-indicator-counter" data-toggle="counter" data-end="1264">0</span></div>
                        </div>
                        <div class="user-stats-milestone"><span>Current Progress</span>
                            <div class="progress">
                                <div class="progress-bar progress-bar-primary" style="width: 45%"></div>
                            </div>
                        </div><a class="user-stats-more-details" href="#">More Details</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="widget widget-fullwidth ads-chart">
                        ...
                        <div class="ads-resume">
                            <div class="ads-info">
                                <div class="ads-progress"><span class="ads-progress-counter" data-toggle="counter" data-end="55" data-suffix="%">0</span><span class="ads-progress-title">Advance</span>
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-primary" style="width: 55%"></div>
                                    </div>
                                </div>
                                <div class="ads-legend" id="ads-chart-legend"></div>
                            </div>
                            <div class="ads-users">
                                <div class="widget-chart-container">
                                    <div id="users-chart" style="height: 153px;"></div>
                                    <div class="users-chart-counter"><span class="users-counter" data-toggle="counter" data-end="1207">0</span><span class="users-title">New Users</span></div>
                                </div>
                            </div>
                        </div>
                        <div class="widget-chart-container">
                ...
                <div class="col-12">
                    <div class="project-list">
                        ...
                        <div class="project-item">
                            ...
                            <div class="project-item-date"><span class="date">May 6, 2018</span><span class="time description">8:30</span></div>
                        ...
                        <div class="project-item">
                            ...
                            <div class="project-item-date"><span class="date">April 22, 2018</span><span class="time description">14:45</span></div>
                        ...
                        <div class="project-item">
                            ...
                            <div class="project-item-date"><span class="date">April 15, 2018</span><span class="time description">10:00</span></div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="widget widget-fullwidth earnings">
                        ...
                        <div class="earnings-resume">
                            <div class="earnings-value earnings-value-big"><span class="earnings-counter" data-toggle="counter" data-end="127.95" data-decimals="2" data-prefix="$">0</span><span class="earnings-title">Advance</span></div>
                            <div class="earnings-value"><span class="earnings-counter" data-toggle="counter" data-end="527" data-decimals="2" data-prefix="$">0</span><span class="earnings-title">Estimated</span></div>
                            <div class="earnings-value"><span class="earnings-counter" data-toggle="counter" data-end="79" data-suffix="%">0</span><span class="earnings-title">More Sales</span></div>
                        </div>
