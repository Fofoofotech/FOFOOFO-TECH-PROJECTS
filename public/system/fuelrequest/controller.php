...
$drivers=$sql->GETALL($sql->Prepare("SELECT DR_CODE,DR_FIRSTNAME,DR_SURNAME FROM pol_drivers WHERE DR_STATUS='1' "),array());

$vehicles=$sql->GETALL($sql->Prepare("SELECT VH_CODE,VH_NAME,VH_DEPARTMENTNAME,VH_MODLE FROM pol_vehicles WHERE VH_STATUS='1'"),array());
