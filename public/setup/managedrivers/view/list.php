 ...
 <div class="wrapper">
       ...
       <div class="input-group">
                 <div class="col-sm-2 mo-mb-2">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            <input type="text" tabindex="1"  class="form-control square-input" name="fdsearch" placeholder="Enter Driver Name/Tag Search"
                            />
          ...
          <div class="col-lg-12" style="padding-top: 50px">
            ...
            <button type="submit" onclick="document.getElementById('target').value='add';document.getElementById('viewpage').value='reset';" class="btn btn-success waves-effect waves-light"><i class="fa fa-plus-circle"></i> Add Driver </button>
          </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    if($pgnate->total_rows > 0){
                                      ...
                                      <?php 
                                    //   echo $obj->CLT_STATUS;
                                      if ($obj->DR_STATUS=='1'){ echo '<span class="badge badge-primary">Active</span>';
                             ...
                             <td class="hidden-xs">
                              ...
                              <div class="btn-group m-b-10">
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(79px, 37px, 0px); top: 0px; left: 0px; will-change: transform;">
                                            <button class="dropdown-item"  type="submit" onclick="$('#viewpage').val('edit');$('#target').val('edit');$('#keys').val('<?php echo $obj->DR_CODE; ?>');"><b>Edit</b></button>

                                           <button type="button" class="dropdown-item" onclick="deleteuser('<?php echo $obj->DR_CODE; ?>');"><b>Delete</b></button>
                                 
                                            <!-- <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="#">Separated link</a> -->

                                              <button class="dropdown-item"  type="submit" onclick="$('#viewpage').val('details');$('#target').val('details');$('#keys').val('<?php echo $obj->DR_CODE; ?>');"><b>Details</b></button>
