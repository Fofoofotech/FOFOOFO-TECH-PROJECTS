   ...
   <div class="row">
        ...
        <div class="col-md-12">
           <div class="card card-default">
             <div class="card-header card-header-divider md-3">[ : EDIT ]
                        
                <span class="pull-right">
                 <button type="submit" class="btn btn-primary" onclick="$('#viewpage').val('update');"><span class="icon s7-check"></span>Update</button>
