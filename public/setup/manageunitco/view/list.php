                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title"> <i class="dripicons-duplicate"></i> Manage Unit.COs</h4>
                        </div>
                    </div>
                </div>
 ...
 <div class="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                          ...
                          <p> <div class="mt-0 header-title m-b-30">C.Os</div></p>
        ...
        <div class="input-group">
          ...
          <div class="form-group row float-right" style="margin-right:20px; padding-top:40px">
            ...
            class="btn btn-success waves-effect waves-light"><i class="fa fa-plus-circle"></i> Add C.O </button>
          </div>
          ...
          <div class="col-lg-12" style="padding-top: 60px">
                                ...
                                <table class="table table-hover">
                                    ...
                                    if($pgnate->total_rows > 0){
                                      ...
                                      <td><?php echo $obj->UNCO_TAGNUM?></td>
                                       <td><?php echo $obj->UNCO_UNITNAME?></td>
                                      <td><?php echo $obj->UNCO_MOBILE?></td>
                                     ...
                                     <td>
                                      <?php 
                                       // echo $obj->UNCO_STATUS;
                                      if ($obj->UNCO_STATUS=='1'){ echo '<span class="badge badge-primary">Active</span>';
                                            }else{
                             ...
                             <td class="hidden-xs">
                                 ...
                                 <div class="btn-group m-b-10">
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(79px, 37px, 0px); top: 0px; left: 0px; will-change: transform;">
                                            <button class="dropdown-item"  type="submit" onclick="$('#viewpage').val('edit');$('#target').val('edit');$('#keys').val('<?php echo $obj->UNCO_CODE; ?>');">Edit</button>

                                           <button type="button" class="dropdown-item" onClick="deleteuser('<?php echo $obj->UNCO_CODE;?>');">Delete</button>
