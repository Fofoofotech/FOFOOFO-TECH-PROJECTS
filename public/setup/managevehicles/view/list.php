                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title"> <i class="dripicons-duplicate"></i>MANAGE FLEET</h4>
                        </div>
                    </div>
                </div>
 ...
 <div class="wrapper">
       ...
       <div class="input-group">
          ...
          <div class="col-lg-12" style="padding-top: 50px">
            ...
            <button type="submit" onclick="document.getElementById('target').value='add';document.getElementById('viewpage').value='reset';" class="btn btn-success waves-effect waves-light"><i class="fa fa-plus-circle"></i> Add Vehicle </button>
          </div>
