                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">ADD VEHICLES</h4>
             ...
             <div class="tab-pane active p-3" id="personal" role="tabpanel">
                                ...
                                <div class="col-lg-4">
                                  <label for="sname">vehicle Name<span class="alert-danger">*</span></label>
                                        <input type="text" class="form-control"  id="vname" placeholder="Enter Vehcle Name" name="vname"/>
                                 ...
                                 <div class="col-lg-4">
                                  <label for="name">Vehicle Number<span class="alert-danger">*</span></label>
                                        <input type="text" class="form-control"  id="vnum" placeholder="Enter Number" name="vnum"/>
                              ...
                              <div class="col-lg-4">
                                <label for="modle">Modle<span style="color:red">*</span></label>
                                 <input class="custom-select" name="modle" id="modle" placeholder="select modle">
                              ...
                              <div class="form-group row">
                                            ...
                                            <label>Fuel Consumption</label>
                                                    <input type="text" class="form-control" id="fuel" name="fuel" placeholder="Enter Fuel Consumption"/>
                                           ...
                                           <div class="col-lg-4">
                                                <label for="make">Chasis : <span style="color:red">*</span></label>
                                                        <input type="text" class="form-control" id="chasis" name="chasis" placeholder="Enter Vehicle Chasis"/>
